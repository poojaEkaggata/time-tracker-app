...
const UserWeeklyHours = () => 
{
 ...
 const getDayName = (dayIndex) => 
 {
  ...
  startDate.setDate(startDate.getDate() + (selectedWeek - 1) * 7 - startDate.getDay() + 1);
  endDate.setDate(endDate.getDate() + (selectedWeek - 1) * 7 - endDate.getDay() + 7);
          ...
          <>
            <div className="row mt-3 mb-3">
              <div className="col d-flex justify-content-start" style={{ marginLeft: '90px' }}>
                ...
                <input type="text" className="form-control" value={`${selectedYear}, ${monthNames[selectedMonth]}, ${startDate.getDate()},${monthNames[startDate.getMonth()]}-${endDate.getDate()},${monthNames[endDate.getMonth()]}`} readOnly style={{ marginLeft: '10px', marginRight: '10px', width: '460px', textAlign: 'center', fontWeight: 'bold' }} />
                ...
                <table className="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      {[...Array(7)].map((_, index) => (
                        <th key={index} style={{ background: '#f2f2f2' }}>{getDayName(index)},{startDate.getDate() + index}</th>
                      ))}
